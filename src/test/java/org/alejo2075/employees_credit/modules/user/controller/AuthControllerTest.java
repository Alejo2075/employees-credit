...
class AuthControllerTest {
    ...
    @Test
    void registerUser_InvalidDetails() throws Exception {
    ...
    void loginUser_Unauthorized() throws Exception {
        ...
        when(authService.login(any(AuthenticationRequest.class))).thenThrow(new AuthenticationException("Invalid credentials"));
